        ...
        <div className="grid gap-10 mb-20 md:grid-cols-2">
          {education.map((edu, idx) => (
            <motion.div
              ...
              className="relative p-6 sm:p-8 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-lg shadow-xl overflow-hidden group"
            >
              ...
              {/* Hover glow effect */}
              <div className="absolute inset-0 bg-gradient-to-br from-orange-400/10 via-pink-500/10 to-yellow-500/10 opacity-0 group-hover:opacity-100 blur-3xl transition duration-700"></div>
        ...
        <AboutSection
          ...
          content={
            <motion.div
              ...
              className="relative p-6 sm:p-8 rounded-2xl bg-white/10 border border-white/20 backdrop-blur-lg shadow-xl overflow-hidden group"
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-orange-500/10 via-pink-500/10 to-yellow-500/10 opacity-0 group-hover:opacity-100 blur-3xl transition duration-700"></div>
              ...
              <div className="flex flex-col items-center text-center mb-6 relative z-10">
                ...
                <p className="text-gray-300 text-sm italic">May – August 2025</p>
              </div>
